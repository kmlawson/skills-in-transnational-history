...
## Week 1 - History in Practice - Strategies for Research in Transnational History   

In this first week we will speak more generally about research in transnational history. As is clear from this handbook, our emphasis in this course is on a small set of skills related to databases, networks, mapping, and GIS which each require far more time than a single module can offer for any degree of significant mastery. 

In this session, however, we will speak more broadly of the range of tools and skills that are useful to historians, and especially transnational and spatial historians. These are by no means limited to the realm of computer software and technologically advanced methodologies. We will explore some of the variety of challenges are particularly common to projects which deal with multiple scales, archives in multiple languages, and require careful organisation and note taking practices. 

We will then go on to discuss the cluster of practices and problems that represent the evolving field of the "digital humanities" and how this module may be seen as representing a part of it. We will revisit this topic again in weeks 6 and 11, when we will be introduced to critiques and reflections within the field.

During class we will have a look at some of the kinds of tasks that can be made easier by learning a bit more on the technological front. For this we will browse through the lessons at the [Programming Historian](http://programminghistorian.org/lessons/)

## Week 2 - Introduction to Historical GIS

This week will explore the development of Historical GIS, but more broadly the analysis of geographic data within the humanities in general, as well as some of its basic approaches and promise. We will discuss Franco Moretti as one example of an experimental application in literature, and together spend some time examining and critiquing various more recent projects online. 
...
Graser, Anita. *Learning QGIS 2.0*. Packt Publishing Ltd, 2013.

## Week 4 - QGIS - Historical Maps and Georectification
...
## Week 5 - Map Design and Deployment Techniques 
...
## Week 6 - Thinking With/Against Maps and Geographical Information
...
"Elements of Historical Knowledge About Urban Spaces: Reflections
on the Requirements for a Dynamic Map" in Rau, Susanne, Ekkehard Schönherr, eds. *Mapping Spatial Relations, Their Perceptions and Dynamics: The City Today and in the Past. Lecture Notes in Geoinformation and Cartography*. Cham ; New York: Springer, 2014. [Library ebook](http://dx.doi.org/10.1007/978-3-319-00993-3)
...
Jobst, Markus, eds. *Preservation in Digital Cartography: Archiving Aspects*. Berlin ; London: Springer, 2010.

## Week 7 - Prosopography and Networks in the Humanities
...
## Week 8 - Developing a Network Database
...
Cherven, Ken. *Mastering Gephi Network Visualization*. Packt Publishing Ltd, 2015, selections
...
Rodogno, Davide, Bernhard Struck, and Jakob Vogel, eds. Shaping the Transnational Sphere: Experts,

Networks and Issues from the 1840s to the 1930s. New York: Berghahn Books, 2014. (Introduction)
...
Folsom, Ed. “Database as Genre: The Epic Transformation of the Archives,]()”
